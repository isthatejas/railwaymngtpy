...
def table_creation_railway():
    import mysql.connector
    mydb=mysql.connector.connect(host='localhost',user='root',passwd='raunak01',database='pass')
    cursor=mydb.cursor()
...
def table_creation_user_accounts():
    import mysql.connector
    mydb=mysql.connector.connect(host='localhost',user='root',passwd='pass',database='railway')
    cursor=mydb.cursor()
    mydb.autocommit=True
...
def signinchecking():
    import mysql.connector
    mycon=mysql.connector.connect(host='localhost',user='root',passwd='pass',database='railway')
    cursor=mycon.cursor()
